     ...
     <span v-show="categoryView.category1Name">{{
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :lst="goodInfo" :skuImageList="skuImageList"/>
          <!-- 小图列表 -->
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            <h3 class="InfoName">{{ skuInfo.Name }}</h3>
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a @click="addShopcar">加入购物车w</a>
                <router-link to="/shopcart">直接加入购物车</router-link>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...mapGetters(['skuInfo', 'price', 'spuSaleAttrList', 'categoryView', 'skuImageList']),
